...
arquivo2 = open("/home/usuario/ar2gems/bin/plugins/Geostat/python/plot/saida_varmap.txt","r")
gdiscrete = int(arquivo2.readline())
ncontour = int(arquivo2.readline())
arquivo2.close()
azimute_adm, lag_adm, continuidade = np.loadtxt("/home/usuario/ar2gems/bin/plugins/Geostat/python/plot/saida_varmap.txt",dtype= float,delimiter="	", skiprows = 2, usecols=(0,1,2), unpack=True)
